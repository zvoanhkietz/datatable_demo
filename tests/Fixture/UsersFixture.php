...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => 'Male', 'comment' => '', 'precision' => null, 'fixed' => null],
        'phone' => ['type' => 'string', 'length' => 13, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'fullname' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-05-28 08:03:22',
            'modified' => '2016-05-28 08:03:22',
            'role_id' => 1
        ],
    ];
}
